...
import 'package:hari_new/successn.dart';

class detailsn extends StatefulWidget {
  const detailsn({super.key});

  @override
  State<detailsn> createState() => _detailsnState();
}

class _detailsnState extends State<detailsn> {
  @override
    ...
    return Scaffold(backgroundColor: Colors.white,
        body: Column(
            ...
            children: <Widget>[
              ...
              TextField(
                decoration: InputDecoration(prefixIcon: Icon(Icons.numbers_outlined ),
              ...
              Padding(
                ...
                child: Align
                  (alignment: Alignment.center,
                    ...
                    {Navigator.push(context,MaterialPageRoute(builder: (context)=>const successn()));},
